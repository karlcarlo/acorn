...
<html>
  <head>
    <meta charset="utf-8" />
    <title>riku&#47;Markdown-Syntax-CN - GitCafe</title><link href="/assets/application-5731c48a7796ccd1d3ae916b3ed7135d.css" media="screen" rel="stylesheet" type="text/css" /><script src="/assets/application-eaba6a46f6b51cd0d3753f926cc830da.js" type="text/javascript"></script><!--[if lt IE 8]><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]--><meta content="authenticity_token" name="csrf-param" />
    <meta content="sgJdk+wQs4rlY+6Lm9PR4qFpvZioBeoeLSAgB8PTIyU=" name="csrf-token" /></head>
  <body><header id="header" role="banner">
      <div class="inner cf">
        <a class="logo" href="&#47;"><img alt="GitCafe" src="/assets/logo-ffdfaf961001fc021d235d3311ec0409.png" /></a><span class="slogan">Share a cup of open source</span>
        <nav class="top-nav">
          <ul>
        ...
        <div class="user-nav"><form accept-charset="UTF-8" action="/search" id="search-form" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div><input id="keyword" name="keyword" placeholder="搜索 ..." type="text" /><button class="icon-search">q</button></form><a href="/signin" class="signin-btn">登入</a></div>
      </div>
    </header><div id="content" role="main">
      <div class="inner cf"><header class="title-bar cf">
  <h1>
    <i class="icon"></i><a href="/riku">riku</a> / <strong><a href="/riku/Markdown-Syntax-CN">Markdown-Syntax-CN</a></strong></h1>
  <ul class="repo-stats">
    <li class="watchers">8<strong>关注者</strong>
    </li>
  </ul>
  <div class="actions">
  </div>
</header><div class="repo-desc-clone cf">
  <div class="repo-desc">
    <a href="http:&#47;&#47;wowubuntu.com&#47;markdown" title="http:&#47;&#47;wowubuntu.com&#47;markdown"><i class="icon-home"></i></a><span title="Markdown 语法简体中文版（fork 于繁体中文版 http:&#47;&#47;markdown.tw&#47; ）">Markdown 语法简体中文版（fork 于繁体中文版 http:&#47;&#47;markdown.tw&#47; ）</span>
  </div>
  <div class="clone-urls" id="clone-urls">
    <a class="active" href="git:&#47;&#47;gitcafe.com&#47;riku&#47;Markdown-Syntax-CN.git">Git <span>(只读)</span></a>
    <input id="clone-url" spellcheck="false" type="text" value="git:&#47;&#47;gitcafe.com&#47;riku&#47;Markdown-Syntax-CN.git" />
    <span class="repo-size">(大小: 1.7 MB)</span>
  </div>
  <a class="btn-download" href="&#47;riku&#47;Markdown-Syntax-CN&#47;zipball&#47;master"><i class="icon"></i>下载 (.zip)</a><a class="btn-clone" href="#"><i class="icon arr"></i><i class="icon"></i>抓取</a>
</div><div class="last-commit">
  <h3>最后的提交:</h3><img alt="Riku" class="gravatar" height="16" src="http://gravatar.com/avatar/730f4bb2007b2aabeeed8dc240a0d99f?size=16" width="16" />Riku:  <span class="commit-message">update and deploy to http:&#47;&#47;wowubuntu.com&#47;markdown</span><span class="time"><i class="icon-time"></i>2012-02-07</span>
</div>
<div class="code-browser-wrapper module" id="code">
  <div class="breadcrumb module-hd">
    <div class="shortcuts">
      <i class="icon"></i>快捷键<dl>
        <dt>键盘快捷键:</dt>
        <dd>
          <code>t</code>返回代码浏览器顶部</dd>
        <dd>
          <code>j</code>页面向下移动</dd>
        <dd>
          <code>k</code>页面向上移动</dd>
      </dl>
    </div>
    <i class="icon-code"></i><a href="/riku/Markdown-Syntax-CN/tree/master#code">Markdown-Syntax-CN</a> &#47; syntax.md</div>
  <div class="code-browser">
    <div class="code-browser-inner">
      <div class="tree-browser">
        <ul>
          <li>
            <i class="icon-folder"></i><a href="/riku/Markdown-Syntax-CN/tree/master/Han#code" title="Han (2012-01-18)">Han</a></li>
          <li>
            <i class="icon-folder"></i><a href="/riku/Markdown-Syntax-CN/tree/master/Markdown_1.0.1#code" title="Markdown_1.0.1 (2012-01-18)">Markdown_1.0.1</a></li>
          <li>
            <i class="icon-folder"></i><a href="/riku/Markdown-Syntax-CN/tree/master/stylesheets#code" title="stylesheets (2012-01-18)">stylesheets</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/Makefile#code" title="Makefile (2012-01-18)">Makefile</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/README.md#code" title="README.md (2012-01-18)">README.md</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/basic.html#code" title="basic.html (2012-02-06)">basic.html</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/basic_content.html#code" title="basic_content.html (2012-02-06)">basic_content.html</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/basics.md#code" title="basics.md (2012-02-06)">basics.md</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/basics.text#code" title="basics.text (2012-01-17)">basics.text</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/content.html#code" title="content.html (2012-02-07)">content.html</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/deploy.sh#code" title="deploy.sh (2012-01-18)">deploy.sh</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/footer.html#code" title="footer.html (2012-01-18)">footer.html</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/header.html#code" title="header.html (2012-01-18)">header.html</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/index.html#code" title="index.html (2012-02-07)">index.html</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/makrdown.html#code" title="makrdown.html (2012-01-18)">makrdown.html</a></li>
          <li class="active">
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/syntax.md#code" title="syntax.md (2012-02-07)">syntax.md</a></li>
          <li>
            <i class="icon-file"></i><a href="/riku/Markdown-Syntax-CN/blob/master/syntax.text#code" title="syntax.text (2012-01-17)">syntax.text</a></li>
        </ul>
      </div>
      <div class="code-preview">
        <div class="file" id="file"><div class="file-meta">
  <i class="icon-file"></i><a class="btn" href="&#47;riku&#47;Markdown-Syntax-CN&#47;raw&#47;master&#47;syntax.md">原始文档</a>syntax.md &#47; 26.9 KB &#47; 721 行</div>
<div class="last-commit"><img alt="Riku" class="gravatar" height="16" src="http://gravatar.com/avatar/730f4bb2007b2aabeeed8dc240a0d99f?size=16" width="16" />Riku:  <span class="commit-message">著作权改为版权</span><span class="time"><i class="icon-time"></i>2012-02-07</span>
</div>
<article class="file-content"><p><strong>NOTE:</strong> This is Simplelified  Chinese Edition Document of Markdown Syntax. If you are seeking for English Edition Document. Please refer to <a href="http://daringfireball.net/projects/markdown/syntax">Markdown: Syntax</a>.</p>
...
<a href="#code" id="back2top"><i class="icon"></i></a>
<style type="text/css">@font-face {
    font-family: 'Ubuntu Mono';
    font-style: normal;
    font-weight: normal;
    src: local('Ubuntu Mono'), local('UbuntuMono-Regular'), url('http://themes.googleusercontent.com/static/fonts/ubuntumono/v3/ViZhet7Ak-LRXZMXzuAfkbrIa-7acMAeDBVuclsi6Gc.woff') format('woff');
  }</style></div>
      </div>
    </div>
  </div>
      ...
      <div class="inner cf">
        <div class="mod">
          ...
          <ul>
            ...
            <li><a href="mailto:support@gitcafe.com">联系我们</a></li>
          </ul>
        </div>
        <div class="mod">
          <h4>相关文档</h4>
          <ul>
            <li><a href="/beginning_git">开始 Git</a></li>
            <li><a href="/why_gitcafe">为何使用 GitCafe</a></li>
            <li><a href="/terms_of_service">服务条款</a></li>
          </ul>
        </div>
        <div class="mod">
          <h4>语言</h4>
          <ul>
            <li><a href="/?locale=zh-CN">简体中文</a></li>
            <li><a href="/?locale=zh-TW">繁体中文</a></li>
            <li><a href="/?locale=en">English</a></li>
          </ul>
        </div>
        <p id="copyright">© 2012 GitCafe Inc. 保留所有权利</p>
      </div>
    </footer><script type="text/javascript">var _gaq = _gaq || [];
      _gaq.push(['_setAccount', 'UA-254297-14']);
      _gaq.push(['_trackPageview']); 
      (function() {
        var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true;
        ga.src = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + '.google-analytics.com/ga.js';
        var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
      })();</script><!--GitCafe version: 0.1.12-->
  </body>
</html>